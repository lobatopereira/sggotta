...
var endpoint = '/api/c/g/distribution/report/summury/by-month/this-year/total-price'
$.ajax({
    method: "GET",
    url: endpoint,
    success: function(data){
        ...
        const config_gclubfedassoc = {
            type: 'line',
            data: dt,
            options: groupoption_price
        };
        const gProductDistributionPriceChart_data = new Chart(
            document.getElementById('gProductDistributionPriceChart_data'),
