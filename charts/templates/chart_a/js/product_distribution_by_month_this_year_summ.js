...
var endpoint = '/api/c/g/distribution/report/summury/by-month/this-year'
$.ajax({
    method: "GET",
    url: endpoint,
    success: function(data){
        ...
        const gProductDistributionChart_data = new Chart(
            document.getElementById('gProductDistributionChart_data'),
